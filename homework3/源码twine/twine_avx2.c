/* twine_avx2.c - TWINE-128 AVX2 Parallel */
#include "twine.h"
#if defined(_MSC_VER)
  #include <intrin.h>
#else
...
static void enc_blk(const uint8_t *pt,uint8_t *ct,const twine_ctx *ctx){
    uint8_t B[16];
